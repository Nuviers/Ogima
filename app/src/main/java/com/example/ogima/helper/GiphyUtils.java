...
public class GiphyUtils {
    ...
    private GiphyDialogListener dialogListener;
    ...
    public interface GiphyDialogListener {
        void onGiphyDialogDismissed();
    }
    ...
    public void selectGif(Context context, GifSelectionListener listener) {
        ...
        gdl.setGifSelectionListener(new GiphyDialogFragment.GifSelectionListener() {
            ...
            public void onDismissed(@NonNull GPHContentType gphContentType) {
                ...
                if (gdl.getTag().equals("CriarPostagemComunidadeActivity")) {
    ...
    public void selectGifPostagem(Context context, GifSelectionListener listener, GiphyDialogListener dialogListener) {
