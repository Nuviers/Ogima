...
public class AdapterGerenciarUsersComunidade extends RecyclerView.Adapter<AdapterGerenciarUsersComunidade.MyViewHolder> {
    ...
    public AdapterGerenciarUsersComunidade(List<Usuario> listUsuario, Context c, TextView txtViewSelecaoParticipantes, Button btnProximaEtapaComunidade, int limiteSelecaoUsers, String funcaoEscolhida) {
        this.context = c;
        this.listaUsuario = listUsuario;
        this.txtViewParticipantes = txtViewSelecaoParticipantes;
        this.btnEnviarParticipantes = btnProximaEtapaComunidade;
    ...
    public void onBindViewHolder(@NonNull MyViewHolder holder, int position) {
        ...
        if (usuario.getIdUsuario().equals(idUsuarioLogado)) {
            holder.linearLayoutParticipantesComunidade.setVisibility(View.GONE);
        } else {
            holder.linearLayoutParticipantesComunidade.setVisibility(View.VISIBLE);
        }
            ...
            public void onClick(View view) {
                ...
                if (tipoOperacao.equals("despromover")) {
                    if (participantesSelecionados.contains(usuario.getIdUsuario())) {
                        ...
                        selecionarUsuario(usuario.getIdUsuario(), holder.linearLayoutParticipantesComunidade, false);
                    } else {
                        // Caso contrário, adicione-o à lista de usuários selecionados e aumente o contador
                        selecionarUsuario(usuario.getIdUsuario(), holder.linearLayoutParticipantesComunidade, true);
                    }
                } else {
