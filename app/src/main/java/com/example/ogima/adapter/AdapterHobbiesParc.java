...
public class AdapterHobbiesParc extends RecyclerView.Adapter<AdapterHobbiesParc.MyViewHolder> {

    private Context context;
    private ArrayList<String> listaTopicos;
    private ArrayList<String> listaHobbiesEdit;
    ...
    private boolean editJaExibido = false;
    ...
    public ArrayList<String> getListaHobbiesEdit() {
        return listaHobbiesEdit;
    }

    public void setListaHobbiesEdit(ArrayList<String> listaHobbiesEdit) {
        this.listaHobbiesEdit = listaHobbiesEdit;
        notifyDataSetChanged();
    }

    public AdapterHobbiesParc(Context c, ArrayList<String> listTopicos, QuantidadeSelecaoCallback quantidadeSelecaoListener) {
        this.context = c;
    ...
    public void onBindViewHolder(@NonNull MyViewHolder holder, @SuppressLint("RecyclerView") int position) {
        ...
        if (getListaHobbiesEdit() != null && getListaHobbiesEdit().size() > 0
                && !editJaExibido) {
            if (getListaHobbiesEdit().contains(topicoAtual)) {
                contador++;
            ...
            if (contador >= getListaHobbiesEdit().size()) {
                editJaExibido = true;
            }
        }
