...
import com.example.ogima.adapter.AdapterComunidadesPublicasDiff;
...
public class ComunidadesPublicasActivity extends AppCompatActivity implements AdapterComunidadesPublicasDiff.OperacaoComunidadePublicaListener, AdapterComunidadesPublicasDiff.posicaoAnteriorComunidadePublica {
    ...
    private Toolbar toolbarComunidadesPublicas;
    private ImageButton imgBtnBackComunidadesPublicas;
    ...
    //Comunidades
    private AdapterComunidadesPublicasDiff adapterComunidadesPublicas;
    private RecyclerView recyclerComunidadesPublicas;
    ...
    //SearchView
    private FrameLayout frameComunidadesPublicas;
    ...
    protected void onStart() {
        ...
        comunidadeDiffDAO = new ComunidadeDiffDAO(listaComunidades, adapterComunidadesPublicas);
    ...
    private void configurarMaterialSearchView() {
        ...
        materialSearch.setHint("Pesquisar comunidades");
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setSupportActionBar(toolbarComunidadesPublicas);
        setTitle("");

        txtTituloToolbarComunidadeVinculo.setText("Comunidades públicas:");

        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
            btnFiltrarComunidades.setBackgroundTintList(ColorStateList.valueOf(Color.parseColor("#43A047")));
        }
    ...
    private void clickListeners() {
        ...
        imgBtnBackComunidadesPublicas.setOnClickListener(new View.OnClickListener() {
            @Override
    ...
    private void configRecyclerComunidades() {
        ...
        recyclerComunidadesPublicas.setHasFixedSize(true);
        recyclerComunidadesPublicas.setLayoutManager(linearLayoutManagerComunidades);
    ...
    private void inicializandoComponentes() {
        toolbarComunidadesPublicas = findViewById(R.id.toolbarComunidadeVinculo);
        imgBtnBackComunidadesPublicas = findViewById(R.id.imgBtnBackComunidadeVinculo);
        ...
        recyclerComunidadesPublicas = findViewById(R.id.recyclerComunidadeVinculo);
        frameComunidadesPublicas = findViewById(R.id.frameComunidadeVinculo);
        materialSearch = findViewById(R.id.materialSearchComunidadeVinculo);
        txtTituloToolbarComunidadeVinculo = findViewById(R.id.txtTituloToolbarComunidadeVinculo);
    }

    @Override
    public void onComunidadeOperacao(Comunidade comunidadeRecebida, String tipoOperacao) {

        if (tipoOperacao != null && tipoOperacao.equals("remover")) {
            // Remove o comunidade da lista mantendo a ordenação
            comunidadeDiffDAO.removerComunidade(comunidadeRecebida);
