...
public class CommunityActivity extends AppCompatActivity implements CustomBottomSheetDialogFragment.RecuperarFiltrosCallback {
    ...
    private void inicializarComponentes() {
        ...
        materialSearch = findViewById(R.id.materialSearchComunidades);
