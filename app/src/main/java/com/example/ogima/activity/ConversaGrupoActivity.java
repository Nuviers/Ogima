...
public class ConversaGrupoActivity extends AppCompatActivity implements View.OnFocusChangeListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        bottomSheetDialogWallpaper = new BottomSheetDialog(ConversaGrupoActivity.this);
        bottomSheetDialogWallpaper.setContentView(R.layout.bottom_sheet_dialog_wallpaper);

        bottomSheetDialogApagarConversa = new BottomSheetDialog(ConversaGrupoActivity.this);
        bottomSheetDialogApagarConversa.setContentView(R.layout.bottom_sheet_dialog_apagar_conversa);

        bottomSheetDialog = new BottomSheetDialog(ConversaGrupoActivity.this);
    ...
    private void enviarVideo() {
        Matisse.from(ConversaGrupoActivity.this)
    ...
    private void openCropActivity(Uri sourceUri, Uri destinationUri) {
        UCrop.of(sourceUri, destinationUri)
                ...
                .start(ConversaGrupoActivity.this);
    }
    ...
    private void requestRecordingPermission() {
        ActivityCompat.requestPermissions(ConversaGrupoActivity.this,
...
//Funciona porém tá no onStart agora
    ...
    private void solicitaPermissoes(String permissao) {
        ...
        if (!solicitaPermissoes.verificaPermissoes(permissoesNecessarias, ConversaGrupoActivity.this, permissao)) {
            if (permissao != null) {
                solicitaPermissoes.tratarResultadoPermissoes(permissao, ConversaGrupoActivity.this);
            }
        }
    }
            ...
            public boolean onMenuItemClick(MenuItem menuItem) {
                switch (menuItem.getItemId()) {
                    case R.id.anexoCamera:
                        ...
                        if (!solicitaPermissoes.exibirPermissaoNegada) {
                            ImagePicker.Companion.with(ConversaGrupoActivity.this)
                                    .cameraOnly()
                    ...
                    case R.id.anexoMusica:
                        ...
                        if (!solicitaPermissoes.exibirPermissaoNegada) {
                            Intent intentMusica = new Intent(ConversaGrupoActivity.this, FilePickerActivity.class);
                    ...
                    case R.id.anexoDocumento:
                        ...
                        if (!solicitaPermissoes.exibirPermissaoNegada) {
                            Intent intentDoc = new Intent(ConversaGrupoActivity.this, FilePickerActivity.class);
